...
\section{Implementation}
    ...
    \subsection{Software Versions}
        ...
        \begin{itemize}[leftmargin=1.5em, itemsep=2pt]
            \item \textbf{Core shadow mechanic.} Real-time dynamic shadows via
                  UE5 Lumen; shadow-covered regions are mapped to runtime
                  collision volumes so the Orb can traverse them. Lit regions
                  are void; the Orb falls and respawns if it enters one.
        ...
        \begin{enumerate}[leftmargin=1.5em, itemsep=4pt]
            \item \textbf{Shadow mechanic introduction.} A single gap
                  ...
                  \textit{``Walk across the shadow.''}  Rolling the Orb
                  across confirms that shadows are solid and lit regions are
                  void.
            ...
            \item \textbf{Respawn demonstration (optional).}  If the player
                  rolls the Orb into a lit gap before completing either step,
